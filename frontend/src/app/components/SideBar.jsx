            ...
            <aside id="default-sidebar" class=" top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
                    <ul class="space-y-2 font-medium">
                        <li>
                            <Link href="./create_training" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                            ...
                            <span class="ml-3">Create Training</span>
                            </Link>
                        </li>
                        <li>
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Trainings</span>
                            </a>
                        </li>
